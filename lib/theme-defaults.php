	...
	if( function_exists( 'genesis_update_settings' ) ) {
		...
		if ( defined( 'GENESIS_RESPONSIVE_SLIDER_SETTINGS_FIELD' ) ) {
			...
			genesis_update_settings( array(
				...
				'slideshow_more_text'             => __( 'Continue Reading', 'nonprofit' ),
				'slideshow_pager'                 => 0,
...
add_filter( 'genesis_responsive_slider_settings_defaults', 'nonprofit_responsive_slider_defaults' );
function nonprofit_responsive_slider_defaults( $defaults ) {
